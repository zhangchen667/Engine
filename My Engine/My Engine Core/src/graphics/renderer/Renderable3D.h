...
namespace myarcane {
	namespace graphics
	{
		...
		public:
			Renderable3D(glm::vec3& position,glm::vec3&scale,glm::vec3&rotationAxis,float radianRation, Model* model,bool shouldOutline =false);
			...
			inline void setShouldOutline(bool shouldOutline) { m_ShouldOutline = shouldOutline; }
		private:
			//model矩阵相关属性
